...
const getDir = (pathArr: string[]): string => {
  console.log(pathArr);
...
export class Export2Excel {
  ...
  constructor(tabsDescrArr, pathArr: string[], fileName: string) {
  ...
  #setWidths(array, ws) {
    ws.columns.forEach((col, ind: number) => {
...
export function write2excel(excelDataAll, pathArr: string[], fileName: string) {
