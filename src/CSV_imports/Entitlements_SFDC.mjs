...
export const Entitlements_SFDC = () => {
  const fieldDescs = [
    ...
    {
      field: "Product: InContact Name",
      dbcolumn: "InContactName",
      type: "TEXT",
    },
    {
      field: "RC Entitlement: Entitlement Name",
      dbcolumn: "EntitlementName",
      type: "TEXT",
    },
    {
      field: "Product: Product Family",
      dbcolumn: "ProductFamily",
      type: "TEXT",
    },
    {
    ...
    {
      field: "Product: inContact Price",
      dbcolumn: "inContactPrice",
      type: "NUMERIC",
    },
    { field: "Product: Charge Term", dbcolumn: "ChargeTerm", type: "TEXT" },
    { field: "Invoice Terms", dbcolumn: "InvoiceTerms", type: "TEXT" },
    {
      field: "Product: inContact Price Currency",
      dbcolumn: "inContactPriceCurrency",
      type: "TEXT",
    },
    {
      field: "Quantity Or Threshold",
      dbcolumn: "QuantityOrThreshold",
      type: "NUMERIC",
    },
    { field: "Product: Billing Type", dbcolumn: "BillingType", type: "TEXT" },
  ];
  csv2sql({
    table: "Entitlements_SFDC",
    fieldDescs,
    csv_file: configuration.SFDC_ENTITLEMENTS,
    dropTable: true,
  });
};
