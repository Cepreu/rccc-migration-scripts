...
export const Invoices = () => {
    const fields = [
        ...
        {field: 'BILLING_MONTH',        dbcolumn: 'BILLING_MONTH',      type: 'TEXT',       pkey: true},	
        ...
        {field: 'PLAN_PAYMENTTYPEID',   dbcolumn: 'PLAN_PAYMENTTYPEID', type: 'TEXT'}
    ]
...
export const InvoiceLines = () => {
    const fields = [
        ...
        {field: 'ENTITLEMENT_LOG_ID',   dbcolumn: 'ENTITLEMENT_LOG_ID', type: 'INTEGER',    pkey: true},	
